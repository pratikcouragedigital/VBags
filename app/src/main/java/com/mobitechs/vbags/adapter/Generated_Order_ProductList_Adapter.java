...
public class Generated_Order_ProductList_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Generated_Order_ProductList_Adapter(List<My_Order_ProductItems> items) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == VIEW_TYPE_EMPTY) {
            ...
            Generated_Order_ProductList_Adapter.EmptyViewHolder emptyViewHolder = new Generated_Order_ProductList_Adapter.EmptyViewHolder(v);
            return emptyViewHolder;
        }
        v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.generated_order_product_list_details_items, viewGroup, false);
        viewHolder = new Generated_Order_ProductList_Adapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof Generated_Order_ProductList_Adapter.ViewHolder) {
            Generated_Order_ProductList_Adapter.ViewHolder vHolder = (Generated_Order_ProductList_Adapter.ViewHolder) viewHolder;
            ...
            Generated_Order_Details.updatePriceDetails(prodcutCount,allProductPrice,allproductDelCharges);
        }
    }
